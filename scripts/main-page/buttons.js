...
document.querySelectorAll('.action-board-button').forEach(button => {
  button.addEventListener('mouseover', function() {
    ...
    document.querySelector('.options-box-js').classList.add('options-box-active');
    ...
    document.querySelectorAll('.title').forEach(title => {
      if (title.closest('.option-action-board') !== this.closest('.option-action-board')) {
  ...
  button.addEventListener('mouseout', function() {
    ...
    document.querySelector('.options-box-js').classList.remove('options-box-active');
